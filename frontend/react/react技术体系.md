...
- [七、组件的数据加载方式](#七组件的数据加载方式)
  ...
  - [八、事件处理](#八事件处理)
  - [8.1 绑定事件](#81-绑定事件)
  - [8.2 事件handle的写法](#82-事件handle的写法)
  - [8.3 EVent对象](#83-event对象)
  - [8.4 事件的参数传递](#84-事件的参数传递)
  - [8.5 处理用户输入](#85-处理用户输入)
- [九、表单](#九表单)
  - [9.1 受控组件](#91-受控组件)
  - [9.2 textarea标签](#92-textarea标签)
  - [9.3 select标签](#93-select标签)
  - [9.4 处理多个输入](#94-处理多个输入)
  - [9.5 文件input标签](#95-文件input标签)
  - [9.6 受控输入空值](#96-受控输入空值)
  - [9.7 非受控组件](#97-非受控组件)
    - [9.7.1 默认值](#971-默认值)
    - [9.7.2 文件输入](#972-文件输入)
- [十、组件的声明周期](#十组件的声明周期)
